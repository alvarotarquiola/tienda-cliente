...
if (isset($_POST['iso_lang']) AND $_POST['iso_lang'] != "")
{
    $new_iso_lang = $_POST['new_iso_lang'];
    $iso_lang = $_POST['iso_lang'];
	$id_lang = Language::getIdByIsoLang($new_iso_lang);
    
    if($new_iso_lang != $iso_lang)
    {
