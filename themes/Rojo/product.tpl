...
<div id="more_info_block" class="clear">
	...
	{if $attachments}
		...
		{foreach from=$attachments item=attachment}
			<li><a href="{$base_dir}attachment_lang.php?id_attachment={$attachment.id_attachment}">{$attachment.name|escape:'htmlall':'UTF-8'}</a><br />{$attachment.description|escape:'htmlall':'UTF-8'}</li>
		{/foreach}
		</ul>
	{/if}
